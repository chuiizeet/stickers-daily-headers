...
@interface FBANRewardedVideoAdAdapter : FBDisplayAdAdapter <FBAdChooseYourOwnAdViewControllerDelegate, FBAdVideoAdViewControllerDelegate, FBAdEndCardViewControllerDelegate, FBAdPlayableViewControllerDelegate>
{
