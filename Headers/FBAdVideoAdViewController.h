...
- (void)dealloc;
- (id)initWithPlacementID:(id)arg1 adDataModel:(id)arg2 placementDefinition:(id)arg3 useNewLayout:(_Bool)arg4 showCta:(_Bool)arg5 autoplay:(_Bool)arg6 forcedViewTime:(CDStruct_1b6d18a9)arg7 rootViewController:(id)arg8;
