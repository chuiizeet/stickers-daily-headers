...
@interface FBBotDetectionSignalCollector : NSObject
{
}
...
+ (void)initializeSignalCollectionWithConfigDelegate:(id)arg1 withSignalsDelegate:(id)arg2 withDynamicLibraryProviderDelegate:(id)arg3;
