...
@interface FBANInterstitialAdAdapter : FBDisplayAdAdapter <FBAdVideoAdViewControllerDelegate, FBAdEndCardViewControllerDelegate, FBAdDSLBridgeDelegate, FBInterstitialAdInternalDelegate>
{
    _Bool _showEndCard;
