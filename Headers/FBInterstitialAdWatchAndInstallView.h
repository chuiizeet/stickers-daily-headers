...
@class FBAdAudioMuteButton, FBAdChoicesButton, FBAdCloseButton, FBAdInfoButton, FBAdPlacementDefinition, FBAdVideoProgressBar, FBAdViewabilityValidator, FBAdWatchAndActionCoverView, FBGradientView, FBInterstitialAdMediaView, FBNativeAdDataModel, NSString, SKStoreProductViewController, UIScrollView;
