...
+ (id)dataSession;
+ (void)sendBotDetectionSignalsForEventId:(id)arg1 sessionID:(id)arg2 productType:(unsigned long long)arg3 eventType:(id)arg4 withSignalsDict:(id)arg5 withErrorDict:(id)arg6 withLoggerDelegate:(id)arg7 withConfigDelegate:(id)arg8 withDynamicLibraryProviderDelegate:(id)arg9;
