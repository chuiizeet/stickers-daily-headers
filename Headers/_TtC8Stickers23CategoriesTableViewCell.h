...
@interface _TtC8Stickers23CategoriesTableViewCell : UITableViewCell
{
...
@property(nonatomic) __weak NSLayoutConstraint *iconAspectConstraint; // @synthesize iconAspectConstraint;
