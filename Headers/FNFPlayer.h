...
- (id)initWithDisplayEngine:(id)arg1 clock:(id)arg2 config:(CDStruct_9167247c)arg3 asyncTimebase:(_Bool)arg4 enableOpus:(_Bool)arg5;
- (id)initWithDisplayEngine:(id)arg1 config:(CDStruct_9167247c)arg2 asyncTimebase:(_Bool)arg3 enableOpus:(_Bool)arg4;
