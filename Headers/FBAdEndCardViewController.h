...
@class FBAdDetailsAndCTAButtonContainerView, FBAdEndCardNoMediaView, FBAdEndCardScreenshotView, FBAdReportingCoordinator, FBInterstitialAdToolbarView, NSString;
...
- (void)dealloc;
- (id)initWithPlacementID:(id)arg1 adDataModel:(id)arg2 useNewLayout:(_Bool)arg3 rootViewController:(id)arg4;
